...
import frc.robot.commands.PIDCoralPivot;
import frc.robot.commands.CoralGrabRelease;
import frc.robot.commands.ManualCoralPivot;
...
//COMMANDS
  //CoralHold
  private final CoralGrabRelease coralGrab = new CoralGrabRelease(coralHold, Constants.CoralHold.HOLD_SPEED);
  private final CoralGrabRelease coralRelease = new CoralGrabRelease(coralHold, Constants.CoralHold.RELEASE_SPEED);
...
//AUX CONTROLLER
//CoralHold
x1.whileTrue(coralGrab);
b1.whileTrue(coralRelease);

//CoralPivot
y1.whileTrue(coralPivotUp);
a1.whileTrue(coralPivotDown);
menu1.whileTrue(pidCoraltoL2);
view1.whileTrue(pidCoraltoL4);


//map buttons to pidCoraltoL1, pidCoraltoL4
}
